...
class Settings(BaseSettings):
    ...
    max_hours_before_match: int = Field(8, alias="MAX_HOURS_BEFORE_MATCH")
    ...
    max_consecutive_losses: int = Field(999, alias="MAX_CONSECUTIVE_LOSSES")
    daily_loss_limit_percent: float = Field(100.0, alias="DAILY_LOSS_LIMIT_PERCENT")
